...
The SDK provides the constant ``\Enbit\eBaySDK\Sdk::VERSION`` that is set to the current version of the SDK.

.. code-block:: php

    echo Enbit\eBaySDK\Sdk::VERSION;
...
.. code-block:: php
    ...
    echo Enbit\eBaySDK\Trading\Services\TradingService::API_VERSION;
