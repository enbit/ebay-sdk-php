...
use Enbit\eBaySDK\Trading\Enums\ProductIdentiferEnabledCodeType;
...
class ProductIdentiferEnabledCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\Trading\Enums\ProductIdentiferEnabledCodeType', $this->obj);
    }
}
