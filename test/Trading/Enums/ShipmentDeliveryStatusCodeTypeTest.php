...
use Enbit\eBaySDK\Trading\Enums\ShipmentDeliveryStatusCodeType;
...
class ShipmentDeliveryStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\Trading\Enums\ShipmentDeliveryStatusCodeType', $this->obj);
    }
}
