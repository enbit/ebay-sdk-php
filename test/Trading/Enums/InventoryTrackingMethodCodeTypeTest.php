...
use Enbit\eBaySDK\Trading\Enums\InventoryTrackingMethodCodeType;
...
class InventoryTrackingMethodCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\Trading\Enums\InventoryTrackingMethodCodeType', $this->obj);
    }
}
