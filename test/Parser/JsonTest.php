<?php
namespace Enbit\eBaySDK\Parser\Test;
...
class JsonParserTest extends \PHPUnit_Framework_TestCase
{
    public function testCanParseJson()
    {
        ...
        $this->assertEquals('bar', $obj->strings[1]);
        $this->assertInstanceOf('\Enbit\eBaySDK\Test\Mocks\SimpleClass', $obj->simpleClasses[0]);
        $this->assertEquals(888, $obj->simpleClasses[0]->integer);
        $this->assertInstanceOf('\Enbit\eBaySDK\Test\Mocks\SimpleClass', $obj->simpleClasses[1]);
