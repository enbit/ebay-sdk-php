...
use Enbit\eBaySDK\PostOrder\Enums\InquiryEligibilityStatusEnum;
...
class InquiryEligibilityStatusEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\PostOrder\Enums\InquiryEligibilityStatusEnum', $this->obj);
    }
}
