...
use Enbit\eBaySDK\PostOrder\Enums\NoSellerUploadLabelReasonEnum;
...
class NoSellerUploadLabelReasonEnumTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\PostOrder\Enums\NoSellerUploadLabelReasonEnum', $this->obj);
    }
}
