...
use Enbit\eBaySDK\ReturnManagement\Types\ReturnResponseDueType;
...
class ReturnResponseDueTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\ReturnManagement\Types\ReturnResponseDueType', $this->obj);
    }
