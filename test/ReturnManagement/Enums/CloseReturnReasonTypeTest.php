...
use Enbit\eBaySDK\ReturnManagement\Enums\CloseReturnReasonType;
...
class CloseReturnReasonTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\ReturnManagement\Enums\CloseReturnReasonType', $this->obj);
    }
}
