...
use Enbit\eBaySDK\MerchantData\Enums\SkypeContactOptionCodeType;
...
class SkypeContactOptionCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\MerchantData\Enums\SkypeContactOptionCodeType', $this->obj);
    }
}
