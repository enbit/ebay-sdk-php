...
use Enbit\eBaySDK\MerchantData\Enums\PictureUploadPolicyCodeType;
...
class PictureUploadPolicyCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\MerchantData\Enums\PictureUploadPolicyCodeType', $this->obj);
    }
}
