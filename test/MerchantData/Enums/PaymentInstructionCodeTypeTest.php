...
use Enbit\eBaySDK\MerchantData\Enums\PaymentInstructionCodeType;
...
class PaymentInstructionCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\MerchantData\Enums\PaymentInstructionCodeType', $this->obj);
    }
}
