...
use Enbit\eBaySDK\MerchantData\Enums\PayPalAccountLevelCodeType;
...
class PayPalAccountLevelCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\MerchantData\Enums\PayPalAccountLevelCodeType', $this->obj);
    }
}
