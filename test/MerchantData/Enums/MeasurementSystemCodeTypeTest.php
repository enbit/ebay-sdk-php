...
use Enbit\eBaySDK\MerchantData\Enums\MeasurementSystemCodeType;
...
class MeasurementSystemCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\MerchantData\Enums\MeasurementSystemCodeType', $this->obj);
    }
}
