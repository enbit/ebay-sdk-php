...
use Enbit\eBaySDK\MerchantData\Enums\RefundingSourceTypeCodeType;
...
class RefundingSourceTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\MerchantData\Enums\RefundingSourceTypeCodeType', $this->obj);
    }
}
