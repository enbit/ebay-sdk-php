...
use Enbit\eBaySDK\MerchantData\Enums\PaymentHoldStatusCodeType;
...
class PaymentHoldStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\MerchantData\Enums\PaymentHoldStatusCodeType', $this->obj);
    }
}
