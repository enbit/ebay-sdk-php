...
use Enbit\eBaySDK\MerchantData\Enums\ErrorClassificationCodeType;
...
class ErrorClassificationCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\MerchantData\Enums\ErrorClassificationCodeType', $this->obj);
    }
}
