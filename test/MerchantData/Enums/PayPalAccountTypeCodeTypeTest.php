...
use Enbit\eBaySDK\MerchantData\Enums\PayPalAccountTypeCodeType;
...
class PayPalAccountTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\MerchantData\Enums\PayPalAccountTypeCodeType', $this->obj);
    }
}
