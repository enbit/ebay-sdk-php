...
use Enbit\eBaySDK\BulkDataExchange\Types\CreateUploadJobResponse;
...
class CreateUploadJobResponseTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\BulkDataExchange\Types\CreateUploadJobResponse', $this->obj);
    }
