...
use Enbit\eBaySDK\BulkDataExchange\Types\StartUploadJobResponse;
...
class StartUploadJobResponseTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\BulkDataExchange\Types\StartUploadJobResponse', $this->obj);
    }
