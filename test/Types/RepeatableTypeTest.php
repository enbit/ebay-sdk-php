...
use Enbit\eBaySDK\Types\RepeatableType;
...
class RepeatableTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\Enbit\eBaySDK\Types\RepeatableType', $this->obj);
    }
    ...
    {
        $this->setExpectedException('\Enbit\eBaySDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for . Expected string but got integer');
