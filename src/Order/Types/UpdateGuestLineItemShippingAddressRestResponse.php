...
/**
 *
 * @property \Enbit\eBaySDK\Order\Types\ErrorDetailV3[] $errors
 * @property \Enbit\eBaySDK\Order\Types\ErrorDetailV3[] $warnings
 */
class UpdateGuestLineItemShippingAddressRestResponse extends \Enbit\eBaySDK\Order\Types\CheckoutSessionResponse
{
    use StatusCodeTrait;
