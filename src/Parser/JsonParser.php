...
{
    /**
     * @param mixed A PHP object derived from Enbit\eBaySDK\Types\BaseType
    ...
    private static function assignProperties(\Enbit\eBaySDK\Types\BaseType $object, array $properties)
    {
