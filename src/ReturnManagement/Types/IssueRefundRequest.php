 ...
 * @property \Enbit\eBaySDK\ReturnManagement\Types\RefundDetailType $refundDetail
 * @property string $comments
 */
class IssueRefundRequest extends \Enbit\eBaySDK\ReturnManagement\Types\BaseRequest
{
    /**
