 ...
 * @property \Enbit\eBaySDK\BusinessPoliciesManagement\Enums\ErrorSeverity $severity
 * @property \Enbit\eBaySDK\BusinessPoliciesManagement\Enums\ErrorCategory $category
 * @property string $message
 * @property string $exceptionId
 * @property \Enbit\eBaySDK\BusinessPoliciesManagement\Types\ErrorParameter[] $parameter
 */
class ErrorData extends \Enbit\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'parameter' => [
            'type' => 'Enbit\eBaySDK\BusinessPoliciesManagement\Types\ErrorParameter',
            'repeatable' => true,
            'attribute' => false,
