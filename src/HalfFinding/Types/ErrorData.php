 ...
 * @property \Enbit\eBaySDK\HalfFinding\Enums\ErrorSeverity $severity
 * @property \Enbit\eBaySDK\HalfFinding\Enums\ErrorCategory $category
 * @property string $message
 * @property string $exceptionId
 * @property \Enbit\eBaySDK\HalfFinding\Types\ErrorParameter[] $parameter
 */
class ErrorData extends \Enbit\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'parameter' => [
            'type' => 'Enbit\eBaySDK\HalfFinding\Types\ErrorParameter',
            'repeatable' => true,
            'attribute' => false,
