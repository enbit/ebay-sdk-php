 ...
 * @property \Enbit\eBaySDK\Trading\Types\TimeRangeType $EmailDateRange
 * @property string $OrderLineItemID
 */
class GetSellingManagerEmailLogRequestType extends \Enbit\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
