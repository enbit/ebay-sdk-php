 ...
 * @property \Enbit\eBaySDK\Trading\Enums\FeatureIDCodeType[] $FeatureID
 * @property boolean $AllFeaturesForCategory
 */
class GetCategoryFeaturesRequestType extends \Enbit\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
