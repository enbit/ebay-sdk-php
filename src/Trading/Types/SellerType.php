 ...
 * @property \Enbit\eBaySDK\Trading\Enums\CurrencyCodeType $BillingCurrency
 ...
 * @property \Enbit\eBaySDK\Trading\Enums\SellerLevelCodeType $SellerLevel
 * @property \Enbit\eBaySDK\Trading\Types\AddressType $SellerPaymentAddress
 * @property \Enbit\eBaySDK\Trading\Types\SchedulingInfoType $SchedulingInfo
 * @property boolean $StoreOwner
 * @property string $StoreURL
 * @property \Enbit\eBaySDK\Trading\Enums\SellerBusinessCodeType $SellerBusinessType
 * @property boolean $RegisteredBusinessSeller
 * @property \Enbit\eBaySDK\Trading\Enums\SiteCodeType $StoreSite
 ...
 * @property \Enbit\eBaySDK\Trading\Types\CharityAffiliationDetailsType $CharityAffiliationDetails
 * @property double $TransactionPercent
 * @property \Enbit\eBaySDK\Trading\Types\IntegratedMerchantCreditCardInfoType $IntegratedMerchantCreditCardInfo
 * @property \Enbit\eBaySDK\Trading\Types\FeatureEligibilityType $FeatureEligibility
 * @property boolean $TopRatedSeller
 * @property \Enbit\eBaySDK\Trading\Types\TopRatedSellerDetailsType $TopRatedSellerDetails
 * @property \Enbit\eBaySDK\Trading\Types\RecoupmentPolicyConsentType $RecoupmentPolicyConsent
...
class SellerType extends \Enbit\eBaySDK\Types\BaseType
{
    ...
    private static $propertyTypes = [
        ...
        'SchedulingInfo' => [
            'type' => 'Enbit\eBaySDK\Trading\Types\SchedulingInfoType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'CharityAffiliationDetails' => [
            'type' => 'Enbit\eBaySDK\Trading\Types\CharityAffiliationDetailsType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'IntegratedMerchantCreditCardInfo' => [
            'type' => 'Enbit\eBaySDK\Trading\Types\IntegratedMerchantCreditCardInfoType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'IntegratedMerchantCreditCardInfo'
        ],
        'FeatureEligibility' => [
            'type' => 'Enbit\eBaySDK\Trading\Types\FeatureEligibilityType',
            'repeatable' => false,
            'attribute' => false,
        ...
        'TopRatedSellerDetails' => [
            'type' => 'Enbit\eBaySDK\Trading\Types\TopRatedSellerDetailsType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'TopRatedSellerDetails'
        ],
        'RecoupmentPolicyConsent' => [
            'type' => 'Enbit\eBaySDK\Trading\Types\RecoupmentPolicyConsentType',
            'repeatable' => false,
            'attribute' => false,
