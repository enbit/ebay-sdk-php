 ...
 * @property \Enbit\eBaySDK\Trading\Enums\GetAllBiddersModeCodeType $CallMode
 * @property boolean $IncludeBiddingSummary
 */
class GetAllBiddersRequestType extends \Enbit\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
