 ...
 * @property \Enbit\eBaySDK\Trading\Enums\MessageStatusTypeCodeType $Status
 * @property boolean $IncludeMemberMessages
 * @property \DateTime $StartCreationTime
 * @property \DateTime $EndCreationTime
 */
class GetAdFormatLeadsRequestType extends \Enbit\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
