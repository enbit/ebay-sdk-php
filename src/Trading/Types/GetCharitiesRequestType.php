 ...
 * @property \Enbit\eBaySDK\Trading\Enums\StringMatchCodeType $MatchType
 * @property boolean $Featured
 */
class GetCharitiesRequestType extends \Enbit\eBaySDK\Trading\Types\AbstractRequestType
{
    /**
