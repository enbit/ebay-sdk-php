 ...
 * @property \Enbit\eBaySDK\MerchantData\Types\AmountType $EachAdditionalAmount
 * @property \Enbit\eBaySDK\MerchantData\Types\AmountType $EachAdditionalAmountOff
 * @property double $EachAdditionalPercentOff
 * @property \Enbit\eBaySDK\MerchantData\Types\MeasureType $WeightOff
 * @property string $MappedDiscountProfileID
 */
class DiscountProfileType extends \Enbit\eBaySDK\Types\BaseType
{
    /**
