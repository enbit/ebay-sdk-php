 ...
 * @property string $UPC
 * @property string $EAN
 * @property \Enbit\eBaySDK\MerchantData\Types\BrandMPNType $BrandMPN
 * @property \Enbit\eBaySDK\MerchantData\Types\TicketListingDetailsType $TicketListingDetails
 * @property boolean $UseFirstProduct
 * @property boolean $IncludeeBayProductDetails
 */
class ProductListingDetailsType extends \Enbit\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'BrandMPN' => [
            'type' => 'Enbit\eBaySDK\MerchantData\Types\BrandMPNType',
            'repeatable' => false,
            'attribute' => false,
            'elementName' => 'BrandMPN'
        ],
        'TicketListingDetails' => [
            'type' => 'Enbit\eBaySDK\MerchantData\Types\TicketListingDetailsType',
            'repeatable' => false,
            'attribute' => false,
