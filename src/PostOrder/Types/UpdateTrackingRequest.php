...
/**
 *
 * @property \Enbit\eBaySDK\PostOrder\Enums\ShippingCarrierEnum $newCarrierEnum
 * @property string $newCarrierName
 * @property string $newTrackingNumber
 * @property \Enbit\eBaySDK\PostOrder\Enums\ShippingCarrierEnum $usedCarrierEnum
 * @property string $usedCarrierName
 * @property string $usedTrackingNumber
 */
class UpdateTrackingRequest extends \Enbit\eBaySDK\Types\BaseType
{
    /**
