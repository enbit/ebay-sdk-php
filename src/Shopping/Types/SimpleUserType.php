 ...
 * @property \Enbit\eBaySDK\Shopping\Enums\FeedbackRatingStarCodeType $FeedbackRatingStar
 * @property integer $FeedbackScore
 * @property boolean $UserAnonymized
 * @property boolean $NewUser
 * @property \DateTime $RegistrationDate
 * @property \Enbit\eBaySDK\Shopping\Enums\SiteCodeType $RegistrationSite
 * @property \Enbit\eBaySDK\Shopping\Enums\UserStatusCodeType $Status
 * @property \Enbit\eBaySDK\Shopping\Enums\SellerBusinessCodeType $SellerBusinessType
 ...
 * @property \Enbit\eBaySDK\Shopping\Enums\SellerLevelCodeType $SellerLevel
 * @property boolean $TopRatedSeller
 */
class SimpleUserType extends \Enbit\eBaySDK\Types\BaseType
{
    /**
