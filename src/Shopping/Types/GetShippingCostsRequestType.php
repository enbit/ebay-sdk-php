 ...
 * @property \Enbit\eBaySDK\Shopping\Enums\CountryCodeType $DestinationCountryCode
 * @property boolean $IncludeDetails
 */
class GetShippingCostsRequestType extends \Enbit\eBaySDK\Shopping\Types\AbstractRequestType
{
    /**
