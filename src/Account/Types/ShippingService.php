...
/**
 *
 * @property \Enbit\eBaySDK\Account\Types\Amount $additionalShippingCost
 * @property boolean $buyerResponsibleForPickup
 * @property boolean $buyerResponsibleForShipping
 * @property \Enbit\eBaySDK\Account\Types\Amount $cashOnDeliveryFee
 * @property boolean $freeShipping
 * @property string $shippingCarrierCode
 * @property \Enbit\eBaySDK\Account\Types\Amount $shippingCost
 * @property string $shippingServiceCode
 * @property \Enbit\eBaySDK\Account\Types\RegionSet $shipToLocations
 * @property integer $sortOrder
 * @property \Enbit\eBaySDK\Account\Types\Amount $surcharge
 */
class ShippingService extends \Enbit\eBaySDK\Types\BaseType
{
    /**
    ...
    private static $propertyTypes = [
        ...
        'shipToLocations' => [
            'type' => 'Enbit\eBaySDK\Account\Types\RegionSet',
            'repeatable' => false,
            'attribute' => false,
