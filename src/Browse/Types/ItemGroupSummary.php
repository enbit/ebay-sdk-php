...
/**
 *
 * @property \Enbit\eBaySDK\Browse\Types\Image[] $itemGroupAdditionalImages
 * @property string $itemGroupHref
 * @property string $itemGroupId
 * @property \Enbit\eBaySDK\Browse\Types\Image $itemGroupImage
 * @property string $itemGroupTitle
 * @property \Enbit\eBaySDK\Browse\Enums\ItemGroupTypeEnum $itemGroupType
 */
class ItemGroupSummary extends \Enbit\eBaySDK\Types\BaseType
{
    /**
